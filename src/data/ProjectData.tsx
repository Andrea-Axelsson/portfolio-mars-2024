...
const ProjectData: Project[] = [
    ...
    },
    {
        ...
        bodyText: "'Color Generator' is a web application developed to create dynamic color schemes.<br><br> It uses pure JavaScript for its core functionality, including a challenging feature that allows copying the color's hex codes to the clipboard.<br><br> The application retrieves data from TheColorAPI to offer a variety of color options and uses HTML5, CSS3, Font Awesome icons and Google Fonts for an elegant and responsive design.",
